...
inctimer()
fadeeff(1)
if t>=120or btnp"5"or btnp"4"do
resetdev()
...
if not bswap and t>60do
if btnp"5"do startgame()end
if btnp"4"do starttut()end
end
if bswap and t>60do
if btnp"4"do startgame()end
if btnp"5"do starttut()end
end
waittimer()
if wait<=0and wait~=-1do
if tut do
resetdev()
wait=-1
_upd=upd_tut
...
sspr(36,49,55,30,15,46+sin(t%650*.003))
line(67,55+sin(t%650*.003),104,70,13)
sspr(39,119,7,5,62,51+sin(t%650*.003))
sspr(0,81,116,28,5,ly)
sspr(41,39,10,9,46,gy+cos(t*.01)*2.9)
sspr(51,39,10,9,58,gy+cos((t-12)*.01)*2.9)
sspr(61,39,10,9,70,gy+cos((t-22)*.01)*2.9)
rect(0,0,127,127,7)
if not float do
local y1,y2,t1,t2=116,116
if not bswap do
t1="x play"
t2="z tutorial"
else
...
upd_cursor()
if btnp(5)and btnp(4)do
if gems_g>0and hp<maxhp do
sfx"54"
poptim=90
gems_g-=1
hp=maxhp
...
drw_pop(50,90+sin(t*.005)*2,s,6,7)
if gems_g>0do sspr(51,39,10,9,curx*size+4,cury*size-usegem)end
end
if krak do camera()end
rect(0,0,127,127,12)
drw_bubbs()
end
function butt_swap()
...
sspr(41,39,10,9,30,34+sin(t*.02)*.2)
sspr(51,39,10,9,44,48+sin(t*.02)*.2)
sspr(61,39,10,9,30,62+sin(t*.02)*.2)
end
clip(90,75,37,52)
drw_diver()
clip()
...
upd_bubbs()
upd_tutcursor()
if btn"0"do tutl=true end
if btn"1"do tutr=true end
if btn"2"do tutu=true end
if btn"3"do tutd=true end
if tutl and tutr and tutu and tutd do
if tutcan==0do tutcan=1end
end
upd_board()
end
...
function makegems()
allgems=3+flr(rnd(8))
while(allgems>0)local pickedgem choices=rnd(1)if choices<.2do pickedgem="o"elseif choices<.4do pickedgem="g"else pickedgem="r"end rtile=3+flr(rnd(#tiles-3))if tiles[rtile].hasgem=="n"and not tiles[rtile].hasmine do tiles[rtile].hasgem=pickedgem allgems-=1end
end
function makemines()
while(allmines>0)local rtile=flr(1+rnd(#tiles-1))if not tiles[rtile].hasmine and not tiles[rtile].revealed do tiles[rtile].hasmine=true allmines-=1end
nomines=false
end
function upd_board()
for tl=1,#tiles do
if tiles[tl].revealed and tiles[tl].hasmine do
tiles[tl].spx=11
tiles[tl].spy=109
elseif tiles[tl].revealed do
tiles[tl].spx=48
end
end
end
...
if g.hasgem=="r"do
c=15
elseif g.hasgem=="g"do
c=11
elseif g.hasgem=="o"do
c=9
else
c=0
end
...
function drw_diver()
sspr(8,13,28,14,98,60+sin(t*.002)*1.2)
sspr(0,29,37,50,91,79+sin(t*.005)*2)
end
function upd_cursor()
if t>10do
movecursor()
if bswap do
if btnp(5)and not btnp(4)do
new_bubbs(86,100,12,4)
flagtile()
elseif btnp(4)and not btnp(5)do
opentile()
end
elseif not bswap do
if btnp(5)and not btnp(4)do
...
if tutcan>0do
if bswap do
if btnp"5"and tutcan==1do
new_bubbs(86,100,12,4)
flagtile()
tutcan=2
elseif btnp"4"and tutcan==2do
opentile()
tutcan=3
elseif btnp"4"and tutcan==3do
sfx"58"
tutcan=4
elseif btnp"4"and tutcan==4do
sfx"58"
tutcan=5
elseif btnp"4"and tutcan==5do
sfx"58"
tutcan=6
elseif btnp"4"and tutcan==6do
opentile()
tutcan=7
elseif btnp"4"and tutcan==7do
sfx"58"
tutcan=8
elseif btnp"4"and tutcan==8do
sfx"58"
music(0,6000)
startgame()
end
elseif not bswap do
if btnp"5"and tutcan==2do
opentile()
tutcan=3
elseif btnp"5"and tutcan==3do
sfx"58"
tutcan=4
elseif btnp"5"and tutcan==4do
sfx"58"
tutcan=5
elseif btnp"5"and tutcan==5do
sfx"58"
tutcan=6
elseif btnp"5"and tutcan==6do
opentile()
tutcan=7
elseif btnp"5"and tutcan==7do
sfx"58"
tutcan=8
elseif btnp"5"and tutcan==8do
sfx"58"
music(0,6000)
startgame()
elseif btnp"4"and tutcan==1do
new_bubbs(86,100,12,4)
flagtile()
tutcan=2
end
...
local p,pc,ns=0,0,0
if tiles[_t].hasgem=="r"do
sfx"59"
gems_r+=1
p+=1
pc=8
ns=41
elseif tiles[_t].hasgem=="g"do
sfx"59"
gems_g+=1
p+=1
pc=11
ns=51
elseif tiles[_t].hasgem=="o"do
sfx"59"
gems_o+=1
p+=1
pc=9
...
if p>0do
local ox,oy,rtbl=curx*size+7,cury*size+7,{}
if curx<=2do
rtbl={5,10,20,25}
elseif curx>=6do
rtbl={-5,-10,-20,-25}
...
local a,b,fcount=-1,1,0
if cury==0do a,b=0,1end
if cury==cols-1do a,b=-1,0end
for _x=a,b do
for _y=-1,1do
if not(_x==0and _y==0)do
local curtil=_t+_x+_y*cols
if tiles[curtil]do
if not tiles[curtil].revealed
and not tiles[curtil].hasmine do
tiles[curtil].revealed=true
opentiles+=1
score+=.00016
checkgems(curtil)
checkaround2(curtil)
elseif tiles[curtil].hasmine do
tiles[_t].warn+=1
if tiles[curtil].flag do
fcount+=1
end
if opentiles>9do
if tiles[_t].warn>=fw do
if fcount>=fw do
else
if opentiles==#tiles-totmines do
else
battle()
end
end
...
local fcount,a,b=0,-1,1
if _t%cols==1do a,b=0,1end
if _t%cols==0do a,b=-1,0end
for _x=a,b do
for _y=-1,1do
local curtil=_t+_x+_y*cols
if not(_x==0and _y==0)do
if tiles[curtil]do
if tiles[curtil].hasmine do
tiles[_t].warn+=1
tiles[_t].hasb=false
end
if tiles[curtil].flag do
...
if en_ded do mov_en+=.5end
?sp_krak,64+eoff,12+sin(t*.008)*2.2-mov_en
if plr_ded do mov_plr+=1end
?sp_dredge,10+poff,mov_plr+48+sin(t*.005)*2
if hitcnt>0do
if plr_turn do
...
local gems={41,51,61}
for i=1,#gems do
sspr(gems[i],39,10,9,70+(i-1)*18,108)
line(69+(i-1)*18,112,74+(i-1)*18,117,1)
line(69+(i-1)*18,113,74+(i-1)*18,118,1)
line(80+(i-1)*18,112,75+(i-1)*18,117,1)
line(80+(i-1)*18,113,75+(i-1)*18,118,1)
rectfill(78+(i-1)*18,116,82+(i-1)*18,122,1)
end
local c1,c2,c3=7,7,7
if bsel==1do c1=14end
if bsel==2do c2=11end
if bsel==3do c3=9end
...
sspr(120,102,6,7,bselpos[bsel][1]+sin(t*.02)*.3,bselpos[bsel][2])
rect(0,0,127,127,8)
end
function checkwin()
...
local p,kmax,col,dpal=flr(mid(0,_perc,1)*100)
dpal={0,1,1,2,1,13,
6,4,4,9,3,13,
1,13,14}
for j=1,15do
...
if b.typ==1do
circ(b.x+sin(t*.3)*.9,b.y,b.r,b.c)
elseif b.typ==3do
circfill(b.x+sin(t*.3)*.9,b.y,b.r,b.c)
end
end
end
...
for b in all(bubbs)do
if b.typ==2do
circ(b.x+sin(t*.02)*1.2,b.y,b.r,b.c)
end
end
end
function upd_bubbs()
...
for i=1,_n do
local _minage,_rndy=rnd(50),rnd(5)
add(smoke,{
x=_x,
y=_y-_rndy,
c=_ctbl,
