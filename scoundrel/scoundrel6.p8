...
--	shfdeckcopy[2]={remcard=false,suit="clb",rank=3}
--	shfdeckcopy[3]={remcard=false,suit="hrt",rank=2}
--	shfdeckcopy[4]={remcard=false,suit="hrt",rank=3}
...
function drw_win()
	...
	?"\^t\^wscored  "..totscore,11,10+my,0
	?"\^t\^wscored  "..totscore,9,10+my,0
	?"\^t\^wscored  "..totscore,10,11+my,0
	?"\^t\^wscored  "..totscore,10,9+my,0
	?"\^t\^wscored  "..totscore,10,10+my,4
	...
	?"YOUR RUN TOOK "..ceil(gt).." MINUTES!",10,24,7
end
-->8
--updates
function upd_menu()
...
function upd_cards_old()
	if #hand==1 and #routines==0 then
		if hand[1].suit=="hrt" or
					hand[1].suit=="dmd" then
						allgame=false
						updtmr=false
						sfx(49)
						_upd=upd_win
	...
	if #shfdeckcopy==0 then
		local cnt=0
		for i=1,#hand do
			--if only reds
			if hand[i].suit=="hrt" or
						hand[i].suit=="dmd" then
							cnt+=1
			end
		end
		
		if cnt==#hand and #routines==0 then
			allgame=false
			updtmr=false
			sfx(49)
			_upd=upd_win
